...
ANIM_FRAME_SPEED = 333   # ms mỗi frame animation
...
class Player:
    def __init__(self, screen_rect):
        ...
        self.image_idle = try_load_image("C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/mc_normal.png", (self.width, self.height))
        self.frames = [
            try_load_image("C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề9_20260402131643.png", (self.width, self.height)),
            try_load_image("C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề9_20260402131649.png", (self.width, self.height)),
        ]
        self.image_parry = try_load_image("C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề51_20260402134240.png", (self.width, self.height))
        # fallback
...
class Projectile:
    def __init__(self, screen_rect, speed):
        ...
        self.image = try_load_image("C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Fiery katana with ethereal aura.png", (self.width, self.height))
...
class Item:
    def __init__(self, screen_rect):
        ...
        self.image = try_load_image("C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/baogay.png", (self.width, self.height))
        if self.image is None:
            self.image = pygame.Surface((self.width, self.height), pygame.SRCALPHA)
...
def main():
    pygame.init()
    pygame.mixer.init()
    voice_sound = pygame.mixer.Sound(r"C:\Users\HP\OneDrive\Desktop\Code\App-trung-dong-Ngh-a\Thoại-260402_175139.mp3")
    voice_sound.set_volume(1.0)
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    pygame.display.set_caption("Ancient China Evade")
    clock = pygame.time.Clock()
    pygame.mixer.init()
    pygame.mixer.music.load(r"C:\Users\HP\OneDrive\Desktop\Code\App-trung-dong-Ngh-a\videoplayback.mp3")
    pygame.mixer.music.set_volume(0.5)
    pygame.mixer.music.play(-1)
    # Background
    bg_image = try_load_image("C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không-Có-Tiêu-Đề244.png", (SCREEN_WIDTH, SCREEN_HEIGHT))
    if bg_image is None:
    ...
    invincible_timer = 0
    anim_frames = [
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402131904.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402131946.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402131950.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402131954.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402131958.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402132001.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402132004.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402132007.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
        try_load_image(f"C:/Users/HP/OneDrive/Desktop/Code/App-trung-dong-Ngh-a/Không Có Tiêu Đề48_20260402132010.png", (SCREEN_WIDTH, SCREEN_HEIGHT)),
    ]
    anim_index = 0
    anim_timer = 0
    playing_anim = False
